        ...
        <section class="blog-listing gray-bg">
                <div class="container">
                    <div class="row bg-light justify-content-center">
                        <div class="col-sm-4 text-center"><h1 class="mt-3">Career Notices</h1></div>

                        <div class="col-lg-12">
                            <a class="btn btn-primary m-2" href="./CreateCareer.php">Create New Notice</a>
                        </div>
                    </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="blog-grid">
                                        <div class="blog-info">
                                            <h5><a href="#">
                                                <?php
                                                    echo implode(' ', array_slice(str_word_count($row['title'], 2), 0, 12));
                                                    ?>
                                            </a></h5>

                                            <p>
                                                <?php
                                                    echo implode(' ', array_slice(str_word_count($row['subtitle'], 2), 0, 50));
                                                ?>
                                            </p>
                                            <div class="btn-bar">
