            ...
            <div class="row">
                <div class="col-lg-9 sm-padding">
                    <div class="blog-items single-post row">
                        ...
                        <h3>Strategic Area 1: Resilience to Climate Change & Disaster Risk</h3>
                        <img src="img/SA1.jpeg" alt="blog post">

                        <p>Nepal is vulnerable to both climatic and non-climatic hazards. The impact of climate change and disaster are directly observed in lives and livelihood of people in each geographical areas of Nepal. In this context, Himal-I will
                            directly work with the local stakeholders and vulnerable communities to strengthen the institutional capacity and adaptive capacity of vulnerable communities.
                        </p>

                        <p>To minimize climate change and disaster risk in lives and livelihood of vulnerable communities </p>
                        ...
                        <div class="comments-wrapper">
                            ...
                            <div class="comment-form">
                                ...
                                <p>The following interventions will be applied to achieve the objective of SA 1: </p>
                                <ol>
                                    <li>Enhance the capacity of local stakeholders and community people to establish Climate Change and Disaster Risk Reduction and Management (DRRM) provisions at local institutional system </li>
                                    <li>Capacitate the local stakeholder and communities to integrate CCA and DRRM aspects in local plan and its effective implementation</li>
                                    <li>Identify and adopt technology for the early forecast of risk and vulnerability</li>
                                    <li>Coordinate and work with local communities, and national and international likeminded partners on action-research to identify the gaps, challenges and opportunities and scaleup the best practices
                                    </li>
                                    <li>Strengthen and deliver appropriate and effective humanitarian response (relief, response and recovery) to affected communities collaborating with humanitarian agencies and local stakeholders</li>
                                    <li>Develop and strengthen monitoring and evaluation mechanism of the local stakeholders for the resource efficiency and track progress of resilient capacity</li>
                                </ol>
                            </div>
                        </div>
                    </div>
